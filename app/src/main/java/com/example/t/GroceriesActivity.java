...
public class GroceriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnReturn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(GroceriesActivity.this, home.class));
            }
        });
    }
    ...
    private void saveToFirebase() {
        ...
        String id = mDatabase.child("expenses").child("Groceries").push().getKey();
        Expense expense = new Expense(name, date, Double.parseDouble(amount));
        mDatabase.child("expenses").child("Groceries").child(id).setValue(expense);
