...
public class ShoppingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnReturn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ShoppingActivity.this, home.class));
            }
        });
    }
    ...
    private void saveToFirebase() {
        ...
        String id = mDatabase.child("expenses").child("shopping").push().getKey();
        Expense expense = new Expense(name, date, Double.parseDouble(amount));
        mDatabase.child("expenses").child("shopping").child(id).setValue(expense);
