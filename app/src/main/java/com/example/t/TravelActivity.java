...
public class TravelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnReturn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(TravelActivity.this, home.class));
            }
        });
    }
    ...
    private void saveToFirebase() {
        ...
        String id = mDatabase.child("expenses").child("travel").push().getKey();
        Expense expense = new Expense(name, date, Double.parseDouble(amount));
        mDatabase.child("expenses").child("travel").child(id).setValue(expense);
