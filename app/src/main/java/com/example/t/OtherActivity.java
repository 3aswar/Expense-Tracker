...
public class OtherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnReturn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(OtherActivity.this, home.class));
            }
        });
    }
    ...
    private void saveToFirebase() {
        ...
        String id = mDatabase.child("expenses").child("other").push().getKey();
        Expense expense = new Expense(name, date, Double.parseDouble(amount));
        mDatabase.child("expenses").child("other").child(id).setValue(expense);
